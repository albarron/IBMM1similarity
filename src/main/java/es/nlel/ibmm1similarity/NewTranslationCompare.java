...
public class NewTranslationCompare implements Runnable {

	//private final static String basePath = "C:\\Users\\Andreas\\Desktop\\samples\\";
	private final static String basePath = "/media/alberto/SeagateBackupPlusDrive/AAAbackupFromTheOtherSeagateDisk/upc_hd/alberto/UPV/nlp_home/crosslingual/dictLearning/corporaJCRNUEVO/";
	//private final static String objPath = "C:\\Users\\Andreas\\Desktop\\samples\\objects\\";
	private final static String objPath  = "/media/alberto/SeagateBackupPlusDrive/AAAbackupFromTheOtherSeagateDisk/upc_hd/alberto/UPV/nlp_home/plagio/crosslingual/dictlearning/wik_objects1000/";
	...
	public final static Apfloat epsilon = new Apfloat(-0.1,NewTranslationCompare.prec);
	...
	static {
		Class<NewTranslationCompare> c = NewTranslationCompare.class;
...
//	protected static Logger log = Logger.getLogger("translation");
	...
	public NewTranslationCompare(String lang) throws IOException, ClassNotFoundException {
		File dictFile = new File("/media/alberto/SeagateBackupPlusDrive/AAAbackupFromTheOtherSeagateDisk/upc_hd/alberto/UPV/nlp_home/plagio/crosslingual/dictlearning/es-en/DICT/dictionary-es-en.95.dict");
//		File dictFile = new File("/corpus/currentWork/euskaraMAL100212/eseu/Consumer/trainGORKA/Consumer/train/1234/moses_training/giza.eseu/eseu.dict.90");
...
//			log.debug(s);
	...
	public Apfloat calcLenFactor(Double sLen, Double tLen, Double m, Double s){
		...
		Apfloat alf = new Apfloat(lf,NewTranslationCompare.prec);
...
//			List<String> targetFiles = FileIO.getFilesRecursively(new File(basePath+currentLang), ".txt");
			List<String> targetFiles = FileIO.getFilesRecursively(new File("/home/alberto/tmp/onefolder"), ".txt");
...
//				log.debug("Estimated end: " + date);
	...
	public static void main (String[] args) throws Exception{
		List<String> langs = Arrays.asList("es");//,"es","fr","nl","pl");
		...
		for(String currentLang : langs) {
			Thread thread = new Thread(new NewTranslationCompare(currentLang),currentLang);
			thread.start();
			proc.add(thread);
		}
